// Mock data for demo mode (when no database is connected)
...
const mockReviews = [
    ...
    },
    {
        ...
        userName: 'Sarah M.',
        rating: 4,
        comment: 'Great headphones, comfortable for long use. Battery life is impressive.',
    ...
    },
    {
        ...
        userName: 'Mike R.',
        rating: 5,
        comment: 'Perfect fitness companion. Accurate tracking and great battery.',
        createdAt: new Date('2024-02-01')
    }
];

const isDemoMode = () => {
    return !process.env.MONGO_URI && process.env.VERCEL;
};
